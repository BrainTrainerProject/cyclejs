...
export interface PractiseFormAction {
    type: 'practise',
    notecards: string[]
}

export type PractiseFormAction = ShowNotecardFormAction | PractiseFormAction;

export default function PractiseForm(sources: PractiseFormSources): PractiseFromSinks {
...
function loadAction(sources): PractiseFormAction {
    if (sources.props && sources.props.action) {
        return {...sources.props.action}
    }
    return {type: 'show'} as ShowNotecardFormAction;
}

function intent(sources: PractiseFormSources): any {
...
function model(actions: any, state$: any, formAction: PractiseFormAction): any {
